        ...
        <div className="flex flex-col md:flex-row   animate-blur-out items-center justify-between gap-4 px-25 ml-16 mt-25">
            ...
            <div className="flex-2 space-y-4 animate-slide-in-up ">
                ...
                <div className='align-center justify-start px-1 mt-7 flex flex-row gap-10'>
                    <a href="https://github.com/jasjeev013"><FontAwesomeIcon icon={faGithub} size='lg' /></a>
                    <a href="https://www.linkedin.com/in/jasjeev-singh-k-773238247/"><FontAwesomeIcon icon={faLinkedin} size='lg' /></a>
                    <a href="https://x.com/jskkk_013"><FontAwesomeIcon icon={faXTwitter} size='lg' /></a>
                    <a href="mailto:jasjeev99@gmail.com"><FontAwesomeIcon icon={faEnvelope} size='lg' /></a>
                    <a href="https://linktr.ee/jskkk_013"><FontAwesomeIcon icon={faLink} size='lg' /></a>
                    <a href="https://www.cloudskillsboost.google/public_profiles/4b35e1aa-f724-4a09-be18-e15325912653"><FontAwesomeIcon icon={faGoogle} size='lg' /></a>
                </div>
            </div>
