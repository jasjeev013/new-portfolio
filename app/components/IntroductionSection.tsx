...
const IntroductionSection = () => {
    return (
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-25 mt-8 ml-16">
            ...
            <div className="flex-1 w-50 h-50 flex justify-center md:justify-center align-center  ">
